    ...
    return (
        <div>
            <ul className="nav navbar-dark nav-pills nav-fill bg-dark justify-content-center py-2" id="pillNav" role="tablist">
                ...
                <li className="nav-item" role="presentation" key={"feats"}>
                    <button key={"feats-button"} className={"nav-link text-light" + ((props.activeTabName.toLowerCase() === "feats") ? " active" : "")} onClick={() => props.buttonFunction("Feats")} id="contact-tab" data-bs-toggle="tab" type="button" role="tab" aria-selected="true">
                        Feats
                    </button>
                </li>
            </ul>
