                                    ...
                                    <div className="col-3">
                                        <div className="card h-100">
                                            <div className="card-body">
                                                ...
                                                <hr />
                                                {props.charData.cards.warriors[_warriorName].effects.map((description) => { return (<p className="card-text">{description}</p>) })}
                                            </div>
                                        </div>
                                    </div>
                                )
                                        ...
                                        <div className="col-3">
                                            <div className="card h-100">
                                                <div className="card-body">
                                                    ...
                                                    <hr />
                                                    {props.charData.cards.items[_itemName].effects.map((description) => { return (<p className="card-text">{description}</p>)})}
                                                </div>
                                            </div>
                                        </div>
                                    )
                                        ...
                                        <div className="col-3">
                                            <div className="card h-100">
                                                <div className="card-body">
                                                    ...
                                                    <hr />
                                                    {props.charData.cards.invocations[_invocationName].effects.map((description) => { return (<p className="card-text">{description}</p>)})}
                                                </div>
                                            </div>
                                        </div>
                                    )
